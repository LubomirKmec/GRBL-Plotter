...
namespace GRBL_Plotter
{
    public partial class MainForm : Form
    {
        ...
        private const string extensionGCode = ".tap,.ngc,.txt,.nc,.cnc,.gcode";            //   else if (ext == ".nc")
        ...
        private void btnOpenFile_Click(object sender, EventArgs e)
        {
            ...
            openFileDialog1.Filter = "gcode files (*.txt, *.ngc, *.tap, *.nc, *.cnc, *.gcode)|*.txt;*.ngc;*.tap;*.nc;*.cnc;*.gcode|SVG files (*.svg)|*.svg|DXF files (*.dxf)|*.dxf|Drill files (*.drd, *.drl, *.dri)|*.drd;*.drl;*.dri|All files (*.*)|*.*";
...
//            preset2DView();
        ...
        private void btnSaveFile_Click(object sender, EventArgs e)
        {
            ...
            sfd.Filter = "GCode (*.txt)|*.txt|GCode (*.tap)|*.tap|GCode (*.ngc)|*.ngc|GCode (*.nc)|*.nc|GCode (*.cnc)|*.cnc|GCode (*.gcode)|*.gcode|All files (*.*)|*.*";   // "GCode|*.nc";
